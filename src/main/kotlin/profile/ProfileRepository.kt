...
class ProfileRepository {
    ...
    fun getProfile(userId: Uuid): ProfileResponse {
        ...
        val likes =
            likeRepository.getUserReceivedLikeCount(userId)

        val saved =
            savedPostRepository.getSavedPostCount(userId)

        val favoritePlaylists=
            playlistRepository.getFavoritePlaylists(userId)
